...
public class ArrayListTest {
    ...
    ArrayList arrayList1 = new ArrayList(); //test first constructor
    ArrayList arrayList2 = new ArrayList(5); //test second constructor

    ArrayList arrayList3 = new ArrayList(); //test first constructor

    ArrayList arrayList4 = new ArrayList(20); //test second constructor
    ...
    public void testMethodTwo() { //add method
        ...
        assertEquals("e", arrayList2.get(0));
        assertEquals("l", arrayList2.get(1));
        assertEquals("i", arrayList2.get(2));
        assertEquals("z", arrayList2.get(3));
        assertEquals("a", arrayList2.get(4));
    }
